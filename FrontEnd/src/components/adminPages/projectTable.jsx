...
import '../style/projectTable.css';

function ProjectTable({ setShowBottomBar }) {
    ...
    // Logout has been moved to BottomBar component.
    ...
    // inform parent to hide/show bottom bar when entering create/edit modes
    useEffect(() => {
        if (typeof setShowBottomBar === 'function') {
            if (createMode || editingProject) setShowBottomBar(false);
            else setShowBottomBar(true);
        }
        // when unmount, ensure bottom bar visible
        return () => {
            if (typeof setShowBottomBar === 'function') setShowBottomBar(true);
        };
    }, [createMode, editingProject, setShowBottomBar]);

    useEffect(() => {
        fetchProjects(); //mengambil project

        // dropdown close ketika klik di luar dropdown (only for delete popup here)
    ...
    return (
        <section className='section admin-project-section'>
                        ...
                        return (
                            <div className="pagenation-container">    
                                ...
                                >
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" fill="currentColor" className="bi bi-chevron-left" viewBox="0 0 16 16">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16">
